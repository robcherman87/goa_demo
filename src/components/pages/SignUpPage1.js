            ...
            <div className="container">
                ...
                <div className="row">
                    ...
                    <ul className="signup-checklist">
                        ...
                        <li className="wow fadeInUp" data-wow-delay=".2s"><i className="fa fa-times checklist-icon text-gray"></i>Tailor your content</li>
                        <li className="wow fadeInUp" data-wow-delay=".3s"><i className="fa fa-times checklist-icon text-gray"></i>Select a GOLFTEC game plan/lesson pack</li>
                        <li className="wow fadeInUp" data-wow-delay=".4s"><i className="fa fa-times checklist-icon text-gray"></i>Schedule a lesson</li>
                    </ul>
